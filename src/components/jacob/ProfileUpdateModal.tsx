  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: '#222838', border: '1px solid rgba(255,255,255,0.08)' }}
      >
        {/* Header */}
        <div
          className="sticky top-0 z-10 flex items-center justify-between px-6 py-5"
          style={{ background: '#222838', borderBottom: '1px solid rgba(255,255,255,0.06)' }}
        >
          <div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    >
                      <option value="" disabled style={{ background: '#222838' }}>Select your relationship</option>
                      {ROLES.map((r) => (
                        <option key={r} value={r} style={{ background: '#222838' }}>{r}</option>
                      ))}
                    </select>
