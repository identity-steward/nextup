  ...
  const loadData = async () => {
    ...
    if (profile?.athlete_id) {
      const { data } = await supabase
        .from('athletes')
        .select('id, slug, first_name, last_initial, sport, grade, school, team_name, position, bio, city, instagram_handle, twitter_handle, highlight_video_url, image_url, is_active')
    ...
    return (
      <div className="min-h-screen bg-gray-50 pt-24 flex items-center justify-center px-6">
        <div className="bg-white rounded-3xl shadow-lg p-10 max-w-md w-full text-center border border-gray-100">
          ...
          <h2 className="text-2xl font-bold text-navy mb-3">No Athlete Profile Linked</h2>
