        ...
        <div className="grid lg:grid-cols-[1.6fr_1fr] gap-4 lg:gap-5">
          ...
          >
            ...
            <div className="relative h-72 lg:h-80 overflow-hidden">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#070a10] via-[#070a10]/30 to-transparent" />
              ...
              <div className="absolute top-4 right-4">
                <span className="inline-flex items-center bg-[#070a10]/80 backdrop-blur-sm border border-white/15 text-white text-xs font-black px-3 py-1.5 rounded-xl">
                  {featured.stat}
                </span>
              </div>
            </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative h-28 overflow-hidden flex-shrink-0">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-[#070a10]/70 via-transparent to-transparent" />
